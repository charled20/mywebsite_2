...
<head>
    ...
    <title> Rusty Devs | Committed to making your dreams possible</title>
                ...
                <div class="container" data-aos="fade-up">
                    <div class="row">
                        <div class="col-lg-5 col-md-6 text-center">
                            ...
                            <!--PORTRAIT -->
                                <img src="/mywebsite2/img/portrait3.gif">
                            </div>
                        </div>
                    ...
                    <div class="footer-style">
                        <div class="container">
                                ...
                                <div class="contact-text col-lg-9 col-md-5" > 
                                    <h5>Contact Us</h5>
                                    <p>Mobile Number: (PH) (+63) XXX-XXX-XXXX</p><p> Landline Number: (0XX) XXX-XXXX</p><p>Email: craigtrecher@gmail.com</p>
                                </div>
